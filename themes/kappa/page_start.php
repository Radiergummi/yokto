    <main>
		...
		<aside class="module github">
			...
			<div class="container">
				<article>
					<a href="//github.com/Radiergummi/yokto" target="_blank">Yokto on Github</a>
				</article>
			</div>
		</aside>
    </main>
